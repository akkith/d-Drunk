...
public class Utils {
	...
	/**
	 * 枚数が手札にある同じランクのカード枚数とぴったりで、もっともランクの低い役をみつける
	 * @param bot プレイヤ
	 * @param melds 役集合
	 * @return 候補の役
	 */
    ...
    /**
     * 出そうとしている役が、手札のグループ枚数と同じかどうかを判定
     * 例えば、2枚組を出そうとしている時に、実は同じランクのカードを3枚持っている時には false を返す
     * @param bot プレイヤ
     * @param meld 出そうとしている役
     * @return ちょうどサイズが合った役なら true、そうでなければ false
     */
